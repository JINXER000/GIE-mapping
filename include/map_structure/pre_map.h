...
public:
    ...
    std::vector<float3> rt_freeBBX_ll, rt_freeBBX_ur;
    thrust::device_vector<float3> freeBBX_ll_D;
    thrust::device_vector<float3> freeBBX_ur_D;
    int ext_free_num;

public:
    Ext_Obs_Wrapper(int obs_num, int free_num);
